// ＊ GAME_STATE : 狀態機，裡面定義了所有的遊戲狀態。
const GAME_STATE = {
  FirstCardAwaits: "FirstCardAwaits", // 還未翻牌。
  SecondCardAwaits: "SecondCardAwaits", // 還未翻第二張牌。
    ...
    switch (this.currentState) {
      ...
      case GAME_STATE.SecondCardAwaits:
        ...
        if (model.isRevealedCardsMatched()) {
          ...
          // this = setTimeout，由瀏覽器提供，不是我們定義在controller的函示。
        }
        break
    }
...
const model = {
  ...
  isRevealedCardsMatched() {
    ...
    // 運用這個回傳的布林值到 controller 裡去設計 if/else 流程。
}
